...
int main()
{
    ...
    Node node6_1{.left = nullptr, .right = nullptr, .value=6};      /*                     ______14  */
    Node node9{.left = nullptr, .right = nullptr, .value=9};        /*               _____/          */
    Node node11{.left = nullptr, .right = nullptr, .value=11};      /*          __ 8 __              */
